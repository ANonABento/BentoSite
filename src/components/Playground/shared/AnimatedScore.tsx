    ...
    >
      ...
      <div className="relative inline-block">
        ...
        {isNewBest && (
          ...
          >
            <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-semibold bg-[var(--pg-accent-primary)] text-black">

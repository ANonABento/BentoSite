    ...
    <div className={containerClass}>
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-4 py-2 bg-[var(--overlay-strong)]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-[var(--text-on-accent)] opacity-80">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-1.5 rounded hover:bg-[var(--glass-bg)] transition-colors text-[var(--text-on-accent)] opacity-60 hover:opacity-100"
      ...
      <div className="flex-1 relative">
        {isLoading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-[var(--overlay-strong)] z-10">
            ...
            <span className="text-sm text-[var(--text-on-accent)] opacity-60">Loading game...</span>
          </div>
        )}

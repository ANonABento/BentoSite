...
export function GameViewer({ game }: GameViewerProps) {
  ...
  return (
    <div className={containerClass}>
      {/* Controls */}
      <div className="flex-shrink-0 flex items-center justify-between px-4 py-2 bg-gray-900/80">
      ...
      <div className="flex-1 relative">
        {isLoading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black z-10">
            <div className="w-8 h-8 border-2 border-fuchsia-500 border-t-transparent rounded-full animate-spin mb-3" />
            <span className="text-sm text-white/60">Loading game...</span>
          </div>
        )}

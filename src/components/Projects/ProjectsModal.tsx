    ...
    >
      <div
        className={`
          ...
          ${isInitialRender ? '' : 'transition-all duration-200 ease-out'}
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className={`
                ...
                ${isInitialRender ? '' : 'transition-colors duration-150'}
            ...
            <div className="relative">
              <input
                ...
                className={`
                  ...
                  ${isInitialRender ? '' : 'transition-all duration-150'}
                `}
              ...
              {categories.map((category) => (
                <button
                  ...
                  className={`
                    ...
                    ${isInitialRender ? '' : 'transition-all duration-150 transform hover:scale-105'}
                    focus:outline-none focus:ring-2 focus:ring-indigo-500/50
